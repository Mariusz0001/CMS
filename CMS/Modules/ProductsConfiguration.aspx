<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductsConfiguration.aspx.cs" Inherits="CMS.Modules.ProductsConfiguration"  ValidateRequest="false"%>
            ...
            <div id="products" class="col s12">
                ...
                <div style="width: 100%; height: 500px; overflow: auto">
                    <asp:GridView ID="ProductGrid" runat="server" AutoGenerateColumns="false" OnRowCommand="ProductGrid_RowCommand" Width="100%" Height="500px" DataKeyNames="Id" ViewStateMode="Enabled" AllowSorting="True" AllowPaging="False" ShowFooter="False" OnRowEditing="ProductGrid_RowEditing"
                         >
                        <Columns>
                            <asp:ButtonField ButtonType="Button" CommandName="EditProduct" HeaderText="" Text="Edit" ControlStyle-CssClass="btn-small" />
